...
class Boid:
    def __init__(self, w):
        ...
        self.vel = (vx, vy)
        self.acc = (0, 0)
        self.obj = w.create_oval(self.pos[0]-self.r, self.pos[1]-self.r, self.pos[0] +
                                 self.r, self.pos[1]+self.r, fill="blue", outline="white", width=4)
    ...
    def look(self, flock, w):
        ...
        # if flg:
        #     w.coords(self.obj, self.pos[0]-self.r, self.pos[1] -
        #              self.r, self.pos[0] + self.r, self.pos[1]+self.r)
        ...
        self.acc = (self.acc[0] + avgvel[0] + avgpos[0] + avgdis[0] * 2,
